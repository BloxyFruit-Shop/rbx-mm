...
type PetSidebarProps = ItemSidebarProps<PetType>;

export default function PetSidebar({ type, demand }: PetSidebarProps) {
        ...
        <div className="space-y-3">
          {type.spawnChance && (
            <div className="flex items-center justify-between rounded-lg border border-white/10 bg-white/5 p-4 transition-colors duration-200 hover:bg-white/10">
              <span className="text-sm text-white/60">Spawn Chance</span>
          ...
          {type.comesFromEggId && (
            <div className="flex items-center justify-between rounded-lg border border-white/10 bg-white/5 p-4 transition-colors duration-200 hover:bg-white/10">
              <span className="text-sm text-white/60">From Egg</span>
