...
export default function SecurityBanner() {
  ...
  const features = [
    { icon: Shield, text: "100% Verified Middlemen" },
    { icon: Lock, text: "Secure Escrow System" },
    { icon: Eye, text: "24/7 Trade Monitoring" },
    { icon: Clock, text: "Instant Dispute Resolution" }
  ];
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="text-white/70">
              Every trade is protected with multiple layers of security
            </p>
          </div>
